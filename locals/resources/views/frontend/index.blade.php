      ...
      <div class="navbar-inner">
        ...
        <li class="green">
          ...
          <ul>
            ...
            <li><a href="{{asset(Request::getLocale().'/logout')}}">Logout</a></li>
          @else
            <li><a href="{{asset(Request::getLocale().'/login')}}">Login</a></li>
            <li><a href="{{asset(Request::getLocale().'/register')}}">Register</a></li>
          @endif
          </ul>
        </li>
         </ul>
...
<div class="banner">
  <div class="container">
    <div class="banner_info">
      ...
      <a href="{{asset(Request::getLocale().'/register')}}" class="hvr-shutter-out-horizontal">Create your Profile</a>
    </div>
  </div>
...
<div class="grid_1">
      ...
      <img src="{{asset('assets/front-end/images/1.jpg')}}" alt="" class="hover-animation image-zoom-in img-responsive"/>
      ...
      <li><div class="col_1"><a href="view_profile.html">
      <img src="{{asset('assets/front-end/images/2.jpg')}}" alt="" class="hover-animation image-zoom-in img-responsive"/>
             <div class="layer m_1 hidden-link hover-animation delay1 fade-in">
      ...
      <li><div class="col_1"><a href="view_profile.html">
      <img src="{{asset('assets/front-end/images/3.jpg')}}" alt="" class="hover-animation image-zoom-in img-responsive"/>
             <div class="layer m_1 hidden-link hover-animation delay1 fade-in">
                <div class="center-middle">About Him</div>
             </div>
             <h3><span class="m_3">Profile ID : MI-387412</span><br>28, Christian, Australia<br>Corporate</h3></a></div>
      ...
      <li><div class="col_1"><a href="view_profile.html">
      <img src="{{asset('assets/front-end/images/4.jpg')}}" alt="" class="hover-animation image-zoom-in img-responsive"/>
             <div class="layer m_1 hidden-link hover-animation delay1 fade-in">
                <div class="center-middle">About Her</div>
             </div>
             <h3><span class="m_3">Profile ID : MI-387412</span><br>28, Christian, Australia<br>Corporate</h3></a></div>
      ...
      <li><div class="col_1"><a href="view_profile.html">
      <img src="{{asset('assets/front-end/images/5.jpg')}}" alt="" class="hover-animation image-zoom-in img-responsive"/>
             <div class="layer m_1 hidden-link hover-animation delay1 fade-in">
                <div class="center-middle">About Him</div>
             </div>
             <h3><span class="m_3">Profile ID : MI-387412</span><br>28, Christian, Australia<br>Corporate</h3></a></div>
      ...
      <li><div class="col_1"><a href="view_profile.html">
      <img src="{{asset('assets/front-end/images/6.jpg')}}" alt="" class="hover-animation image-zoom-in img-responsive"/>
             <div class="layer m_1 hidden-link hover-animation delay1 fade-in">
                <div class="center-middle">About Her</div>
             </div>
             <h3><span class="m_3">Profile ID : MI-387412</span><br>28, Christian, Australia<br>Corporate</h3></a></div>
  ...
  <div class="container">
    <h2>Success Stories</h2>
         ...
         <li>
          ...
          <div class="suceess_story-content-container">
            <figure class="suceess_story-content-featured-image">
               <img width="75" height="75" src="{{asset('assets/front-end/images/7.jpg')}}" class="img-responsive" alt=""/>                   
              </figure>
          ...
          <div class="suceess_story-content-container">
            <figure class="suceess_story-content-featured-image">
               <img width="75" height="75" src="{{asset('assets/front-end/images/8.jpg')}}" class="img-responsive" alt=""/>                   
              </figure>
            <div class="suceess_story-content-info">
                  <h4><a href="#">Lorem & Ipsum</a></h4>                  
                  <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form,.<a href="#">More...</a></p>
          ...
          <div class="suceess_story-content-container">
            <figure class="suceess_story-content-featured-image">
               <img width="75" height="75" src="{{asset('assets/front-end/images/9.jpg')}}" class="img-responsive" alt=""/>                   
              </figure>
            <div class="suceess_story-content-info">
                  <h4><a href="#">Lorem & Ipsum</a></h4>                  
                  <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form,.<a href="#">More...</a></p>
          ...
          <div class="suceess_story-content-container">
            <figure class="suceess_story-content-featured-image">
               <img width="75" height="75" src="{{asset('assets/front-end/images/10.jpg')}}" class="img-responsive" alt=""/>                    
              </figure>
            <div class="suceess_story-content-info">
                  <h4><a href="#">Lorem & Ipsum</a></h4>                  
                  <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form,.<a href="#">More...</a></p>
          ...
          <div class="suceess_story-content-container">
            <figure class="suceess_story-content-featured-image">
               <img width="75" height="75" src="{{asset('assets/front-end/images/11.jpg')}}" class="img-responsive" alt=""/>                    
              </figure>
            <div class="suceess_story-content-info">
                  <h4><a href="#">Lorem & Ipsum</a></h4>                  
                  <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form,.<a href="#">More...</a></p>
          ...
          <div class="suceess_story-content-container">
            <figure class="suceess_story-content-featured-image">
               <img width="75" height="75" src="{{asset('assets/front-end/images/12.jpg')}}" class="img-responsive" alt=""/>                    
              </figure>
            <div class="suceess_story-content-info">
                  <h4><a href="#">Lorem & Ipsum</a></h4>                  
                  <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form,.<a href="#">More...</a></p>
          ...
          <div class="suceess_story-content-container">
            <figure class="suceess_story-content-featured-image">
               <img width="75" height="75" src="{{asset('assets/front-end/images/13.jpg')}}" class="img-responsive" alt=""/>                    
              </figure>
            <div class="suceess_story-content-info">
                  <h4><a href="#">Lorem & Ipsum</a></h4>                  
                  <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form,.<a href="#">More...</a></p>
      ...
      <div class="col-md-4 row_1-right">
        <h3>News & Events</h3>
          <div class="box_1">
          <figure class="thumbnail1"><img width="170" height="155" src="{{asset('assets/front-end/images/14.jpg')}}" class="img-responsive" alt=""/></figure>
        ...
        <a href="#" class="vertical">Read More</a>
          ...
          <div class="box_1">
          <figure class="thumbnail1"><img width="170" height="155" src="{{asset('assets/front-end/images/15.jpg')}}" class="img-responsive" alt=""/></figure>
        <div class="extra-wrap">
        <div class="post-meta">
          <span class="day">
          <time datetime="2014-05-25T10:15:43+00:00">25</time>
        ...
        <a href="#" class="vertical">Read More</a>
          ...
          <div class="box_2">
          <figure class="thumbnail1"><img width="170" height="155" src="{{asset('assets/front-end/images/1.jpg')}}" class="img-responsive" alt=""/></figure>
        <div class="extra-wrap">
        <div class="post-meta">
          <span class="day">
          <time datetime="2014-05-25T10:15:43+00:00">25</time>
    ...
    <div class="footer">
      <div class="container">
        ...
        <div class="clearfix"> </div>
        <div class="copy">
          <p>Copyright © 2016 MegaMind . All Rights Reserved  | Design by <a href="http://megamind.com/" target="_blank">MegaMind</a> </p>
          </div>
      </div>
    </div>
</body>
