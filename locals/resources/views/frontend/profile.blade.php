          ...
          <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
            <div class="tab_box">
              ...
              <div id="profile-text-area">
                <p id="about_myself_label">{{$profile->about_myself}}</p>
              </div>
              <form onsubmit="return false;" id="profile-text-area-form" action="{{asset(App::getLocale().'/updateProfile')}}" style="display:none;">
                <textarea id="about_myself" name="about_myself" rows="5" style="width:100%">{{$profile->about_myself}}</textarea>
                <br/>
            ...
            <div class="basic_1">
              ...
              <div class="col-md-6 basic_1-left">
                ...
                <form onsubmit="return false;" id="basic-detail-form" action="{{asset(App::getLocale().'/updateProfile')}}" style="display:none;">
                  ...
                  <tr class="opened_1">
                    <td class="day_label">Name :</td>
                    <td class="day_value"><input type="text" id="name" name="name" value="{{$profile->name}}"/></td>
                  </tr>
                    <tr class="opened">
                    <td class="day_label">Status :</td>
                    <td class="day_value">
